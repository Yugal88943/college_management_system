...
<title>Teacher insert Subjects</title>
</head>
<body>
 ...
 <%		String msg = "";
		...
		<form action="Insert_Subject" method="post">
				<table align = "center" class='table'>
					<tr><th colspan="2"><h2><font color="Crimson"><b>Add New Subject</b></font></h2></th>
					</tr>
					
					<tr>		<td colspan=2 align="center"><font color="green"><b><%=msg %></b></font></td>
					</tr>
						<tr>
				<tr><td class='label'><b>Subject </b> </td>
						<td> <input class='input' type = "text" name="sub_name" value=""></td></tr>
				<tr><td><b>Code </b> </td>
						<td> <input class='input' type = "text" name="sub_code" value=""></td></tr>
				<tr><td><b>Paper ID </b></td>
						<td> <input class='input' type = "text" name="paper_id" value=""></td></tr>
				<tr><td><b>Course </b> </td>
				...
				<tr><td class='label'><b>Maximum Marks </b> </td>
						<td> <input class='input' type = "text" name="max_mrks" value=""></td></tr>
				<tr><td><b>Minimum Marks </b> </td>
						<td> <input class='input' type = "text" name="min_mrks" value=""></td></tr>
