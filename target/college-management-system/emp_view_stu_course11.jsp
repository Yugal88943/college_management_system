...
StudentsListActionBean action=new StudentsListActionBean(bean);
	data = action.listStudentsByCourse();
...
%>
 					...
 					<a href="emp_view_stu_course.jsp"><input class='submit' type="button" name="btn_back" value="BACK"/></a>
 					<center><h2><font color="crimson" ><b>List of Students by Course</b></font></h2></center>
