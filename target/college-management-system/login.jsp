...
<jsp:include page="head_menu.jsp"></jsp:include>
	...
	<div class='content'>
		...
		%>
			...
			<form  name="myform" onsubmit="return valid()" action="Login_Check" target="_parent" method="post" >
				...
				<section id='login-content'>
					...
					<aside class='right_secl'>
						...
						<tr><td colspan = 2 align="center">  <a class="forgot" href="forget_password.jsp" target="_parent"><b>Forget Password</b></a></td></tr>
