...
public class ResetPasswordActionBean {
		...
		private String empChangepwdQuery="update employee_details set password=? where username=? and password=?";
		...
		public boolean empChangePassword()
		{
			try{
				prepare = connection.prepareStatement(empChangepwdQuery);
